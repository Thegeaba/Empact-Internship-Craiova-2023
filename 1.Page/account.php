...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Contul meu || Spalding - Magazin online</title>
  ...
  <body>
    ...
    <nav class="top-bar" data-topbar role="navigation">
      ...
      <!-- Right Nav Section -->
        <ul class="right">
          ...
          if(isset($_SESSION['username'])){
            echo '<li class="active"><a href="account.php">Contul meu</a></li>';
    ...
    <div class="row" style="margin-top:30px;">
      <div class="small-12">
        ...
        <p><h4>Detalii cont</h4></p>

        <p>Mai jos sunt prezentate datele contului curent. Data doriti sa faceti o schimbare, introduceti noile date in casete si apasati pe Update </p>
      </div>
    </div>
        ...
        <div class="small-12">
          ...
          <div class="row">
            <div class="small-3 columns">
              <label for="right-label" class="right inline">Prenume</label>
            </div>
            <div class="small-8 columns end">
              <?php
                ...
                if($result) {
                  ...
                  echo '<label for="right-label" class="right inline">Nume</label>';
                  echo '</div>';
                  ...
                  echo '<div class="row">';
                  echo '<div class="small-3 columns">';
                  echo '<label for="right-label" class="right inline">Oras</label>';
                  echo '</div>';
                  echo '<div class="small-8 columns end">';
                  ...
                  echo '<div class="row">';
                  echo '<div class="small-3 columns">';
                  echo '<label for="right-label" class="right inline">Cod postal</label>';
                  echo '</div>';
                  echo '<div class="small-8 columns end">';
              ...
              echo '<div class="row">';
              echo '<div class="small-3 columns">';
              echo '<label for="right-label" class="right inline">Parola</label>';
              echo '</div>';
              echo '<div class="small-8 columns end">';
