...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Inregistrare || Spalding - Magazin online</title>
    ...
    <form method="POST" action="insert.php" style="margin-top:30px;">
      <div class="row">
        <div class="small-8">
          ...
          <div class="row">
            <div class="small-4 columns">
              <label for="right-label" class="right inline">Nume</label>
            </div>
            <div class="small-8 columns">
          ...
          <div class="row">
            <div class="small-4 columns">
              <label for="right-label" class="right inline">Oras</label>
            </div>
            <div class="small-8 columns">
          ...
          <div class="row">
            <div class="small-4 columns">
              <label for="right-label" class="right inline">Cod postal</label>
            </div>
            <div class="small-8 columns">
          ...
          <div class="row">
            <div class="small-4 columns">
              <label for="right-label" class="right inline">Parola</label>
            </div>
            <div class="small-8 columns">
